	...
	<div class="bgimage">
        ...
        <ul>
          ...
          <li> English Teacher</li>
			...
			<div class="rightmenu">
				<ul>
					<li ><a id="menu2" style="margin-left: 145px;" href="teacher2_home.php">Home</a></li>
					<li><a id="menu2" href="teacher2_grades.php">Grades</a></li>
					<li><a id="menu2" href="teacher2_schedules.php">Schedules</a></li>
