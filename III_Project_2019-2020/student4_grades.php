...
$PBPT1 = $bible1[13];
$PBQA1 = $bible1[14];
$SSTU1_GRADE = $science1[15];
$SSTU2_GRADE = $english1[15];
$SSTU3_GRADE = $bible1[15];
?>
<html>
<head>
	<title></title>
	...
	<div class="bgimage">
        ...
        <ul>
          ...
          <li> 403484150075 </li>
			...
			<div class="rightmenu">
				<ul>
					<li ><a id="menu2" style="margin-left: 145px;" href="student4_home.php">Home</a></li>
					<li><a id="menu2" href="student4_grades.php">Grades</a></li>
					<li><a id="menu2" href="student4_schedules.php">Schedules</a></li>
